...
# with command line options: --eventcontent NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --datatier NANOAOD --conditions 106X_dataRun2_v35 --step NANO --era Run2_2018,run2_nanoAOD_106Xv2 --python_filename configs/CustomNano_Recover1_cfg.py --no_exec --data -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:--eventcontent_PAT.root'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('--eventcontent_NANO.root'),
